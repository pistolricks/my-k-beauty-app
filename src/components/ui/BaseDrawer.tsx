...
import {JSXElement, ParentProps, Setter, splitProps, type ValidComponent} from "solid-js";
...
const DrawerContent = <T extends ValidComponent = "div">(
    ...
    const persistedContent = createPersistent(() => <DrawerData children={props.children} />)
    ...
    return (
        <DrawerPrimitive.Content
            ...
            class={cn(
                "border-[#111] bg-corvu-bg w-screen sm:max-w-md sm:right-0",
                sides,
                props.class,
            )}
            {...rest}
...
export const DrawerData: Component<ParentProps> = (props) => {
